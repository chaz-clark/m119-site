...
- Find the first and second derivatives of $f_1$ with respect to $a_1$.
- Find all the first partials and second partials of $f_4$.
- Find the first and second derivatives of $f_5$ with respect to $a_1$.
- Organize your work into a **cohesive analysis** and submit it to Canvas.
...
- Set the first derivative of $f_1$ with respect to $a_1$ equal to zero and solve for $a_1$.
  - Use the second derivative test to confirm you have actually found a maximum of the associated loglikelihood function.
- Set the partial derivatives of $f_4$ to zero and solve the resulting system of equations for $a_1$ and $a_2$. 
  - Use the second derivative test to confirm you have actually found a maximum of the associated loglikelihood function.
- Set the first derivative of $f_5$ with respect to $a_1$ equal to zero and solve for $a_1$.
  - Use the second derivative test to confirm you have actually found a maximum of the associated loglikelihood function.
...
## Project 2: Use the Fitted Models to Answer Questions
- Create a new R Markdown file.
