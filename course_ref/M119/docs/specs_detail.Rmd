---
title: "Project Specs Details"
author: ""
date: "Updated April 25"
output: 
  html_document:
    code_folding: hide
---
...
<!-- *No worries if some of these common errors show up in your work, you can revise. These examples are provided here to help you as you evaluate your own work. Remember we will be practicing the language of mathematics in class.* -->
...
- Some things to watch for include the following. 
    ...
    <!-- - The symbol $\frac{\partial^2 f}{\partial x\partial y} = \frac{\partial}{\partial x}\left(\frac{\partial f}{\partial y}\right)$ and not $\frac{\partial}{\partial y}\left(\frac{\partial f}{\partial x}\right)$.  -->
    <!-- - The symbol $\frac{\partial f}{\partial x}$ is not the same as $\frac{df}{dx}$. -->
    <!-- - The $\displaystyle\sum_{i=1}^7 a_2 t_i y_i$ is not the same as $\displaystyle\sum_{i=1}^7 a_2 t y_i$. -->
    <!-- - The names of functions are specific $L_1(x)$ is not the same as $L(x)$. -->
    <!--     - For example, "given $L_1(x) = \prod_{i=1}^5 x^i$ we see that $L$ is a polynomial." Wait! What's $L$? We have only been given information about $L_1$.  -->
    <!--     - If you have not state a function with it's name (even if it is stated in the instructions of the project) your reader doesn't know what you are talking about. -->
<!-- - If you are unsure of the mathematical words or symbols to communicate an idea, don't fake it, come get help saying what you want to say. -->