...
URL_shiny_p3_t1 <- 'https://posit.byui.edu/content/61f8f45b-2d57-4445-aaf7-aa31b57d7c52'
URL_shiny_p3_t2 <- 'https://posit.byui.edu/content/f9f99c5c-08e5-4ed2-8a91-5410fecba17f'
URL_shiny_p3    <- 'https://posit.byui.edu/content/64518de8-8864-43aa-864c-7d721376663f'
```
...
- **CHECK YOUR WORK:** 
    ...
    - Once you've chosen values for the parameters of each model, use the [Shiny App](`r URL_shiny_p3_t1`) to check your probability calculations.
...
- **CHECK YOUR WORK:** 
    - Use the [Shiny App](`r URL_shiny_p3_t2`) to check the parameters for the fitted functions $f_0$ and $f_3$.
...
- **CHECK YOUR WORK:** 
    - Use the [Shiny App](`r URL_shiny_p3`) to check your answers. 
