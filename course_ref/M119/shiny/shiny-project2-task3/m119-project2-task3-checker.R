#https://shiny.byui.edu/content/d642a2b5-8aec-4a81-983b-39a676beaca5
...
ui <- fluidPage(
  ...
  # App title ----
  titlePanel("Math 119 Project 2 Task 3 - Check Your Work"),
  HTML("<p>Enter the coefficients for the 5 models from Project 2 Task 3, and then click \"Check Solution.\" This app will tell you if your coefficients are correct.<p><br>"),
