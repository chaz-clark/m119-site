...
Because $D = `r D`>0$ and $\ell_{a1a1} = `r la1a1` <0$, then we know that our critical point corresponds to a maximum of $\ell_2$, as desired. We have found the coefficients $a_1$ and $a_2$ that yield a best fit for $f_2$, and our model is 
$$f_2(t;a_1,a_2)=100+`r a.2[1]`t+`r a.2[2]`t^2 \text{ where }t\geq 0.$$
...
Because $D = `r D`>0$ and $\ell_{a1a1} = `r la1a1` <0$, then we know that our critical point corresponds to a maximum of $\ell_6$, as desired. We have found the coefficients $a_1$ and $a_2$ that yield a best fit for $f_6$, and our model is 
$$f_6(t;a_1,a_2)=100+`r a.6[1]`t+`r a.6[2]`(1−e^{−0.0003t}) \text{ where }t\geq 0.$$
...
- $f_2(t;a_1,a_2)=100+`r signif(a.2[1],3)`t+`r signif(a.2[2],3)`t^2 \text{ where }t\geq 0.$
- $f_6(t;a_1,a_2)=100+`r signif(a.6[1],3)`t+`r signif(a.6[2],3)`(1−e^{−0.0003t}) \text{ where }t\geq 0.$
