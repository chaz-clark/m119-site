...
- Project Standards
    ...
    - Demonstrates an understanding of the concept of a loglikelihood function by providing the correct formulas for the loglikelihood functions specified.
    ...
    - Demonstrates understanding that the information we identify using our data depends on which model (function family, for example $f$, $f_0$, $f_1$ or $f_2$) we assume describes the relationship seen in the data and this understanding is demonstrated by an relevant and consistent comparision. 
...
- **Task 4a:** Repeat "Task 2" and "Task 3" for the 3 of the following models.
