...
title: "Class 28"
---
# Between Class Sessions - Prep for Day 28 <a id="tasklist"></a>
...
### (1) Solving a General Linear System with 2 equations and 2 unknowns
Last time the assignment was to solve, or attempt to solve, the system similar to the one below for $x$ and $y$.
$$\left\{
\begin{align*}
...
\end{align*} 
\right.$$
Note that the variables above are different than the ones from last class period, so your answer may look a bit different. 
Solve the system, obtaining values for $x$ and $y$, and come to class with any questions you have about how to obtain the solution.

<details>
<summary>Answer</summary>

There are lots of ways to obtain the solution. Here's a possible answer. 
...
You might try the above code to check answers from your 1 -- Solving Linear Systems assignment.
...
- Continue work on Project 2 Task 3
    - Determine when the derivative of $\ell_5$ is zero. What is the sign of the second derivative of $\ell_5$ at this value of $a_1$? Is there a local maximum or local minimum at this value of $a_1$ (what is the conclusion of the second derivative test in this case)?
      - Check your work. Plot $\ell_5$. Does the value of $a_1$ correspond to an extrema? What your conclusion of a local maximum or local minimum correct?
    - Determine when both partial derivatives of $\ell_4$ are zero (solve the system of linear equations you get when you set both partial derivatives equal to zero). *Hint: You should use the general solution (a formula) you found in your previous between class work.*
...
*Source: [Class.28 on byuimath.com](https://byuimath.com/clarkc/all/119/index.php?n=Class.28)*
