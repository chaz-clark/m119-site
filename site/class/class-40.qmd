...
title: "Class 40"
---
# Between Class Sessions - Prep for Day 40 <a id="tasklist"></a>
...
1. Solve the system $ \left\{\begin{array}{ll}\frac{x}{y} = 2 \\ \frac{x}{y^2} = 3\end{array} \right.$ for $x$ and $y$.

1. Solve the system $ \left\{\begin{array}{ll}\frac{\alpha}{\beta} = 2.7 \\ \frac{\alpha}{\beta^2} = 10.2\end{array} \right.$ for $\alpha$ and $\beta$
...
*Source: [Class.40 on byuimath.com](https://byuimath.com/clarkc/all/119/index.php?n=Class.40)*
