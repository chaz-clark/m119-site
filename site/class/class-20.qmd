...
- Download [this file](https://chaz-clark.github.io/M119/Projects/m119-docs/ChainRule_comparison.pdf){target="_blank"} and complete the exercises. 
...
Note: This tells us the probability model we will be using and it tells us we can multiply the probabilities to get the likelihood function.
