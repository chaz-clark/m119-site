...
$$\begin{aligned}
\sum_{k=2}^5 (3k-1)
  &= \underbrace{(3(2)-1)}_{k=2} + \underbrace{(3(3)-1)}_{k=3} + \underbrace{(3(4)-1)}_{k=4} + \underbrace{(3(5)-1)}_{k=5} \\
  &= 5 + 8 + 11 + 14 \\
  &= 38
\end{aligned}$$
...
$$\begin{aligned}
\prod_{m=2}^5 (3m-1)
  &= \underbrace{(3(2)-1)}_{m=2} \cdot \underbrace{(3(3)-1)}_{m=3} \cdot \underbrace{(3(4)-1)}_{m=4} \cdot \underbrace{(3(5)-1)}_{m=5} \\
  &= 5 \cdot 8 \cdot 11 \cdot 14 \\
  &= 6160
\end{aligned}$$
...
$$\begin{aligned}
\frac{1}{3}\sum_{i=3}^{7} (2+i^2)
  &= \frac{1}{3}\left[(2+3^2) + (2+4^2) + (2+5^2) + (2+6^2) + (2+7^2)\right] \\
  &= \frac{1}{3}(11 + 18 + 27 + 38 + 51) \\
  &= \frac{145}{3}
\end{aligned}$$
