...
- Use the data from <https://en.wikipedia.org/wiki/List_of_Florida_hurricanes_(200080%93presen>t) for the years 2000-2005 (6 years) to estimate a good value for lambda (you'll need to use p3v1 now, as there are 6 data points instead of 3).
