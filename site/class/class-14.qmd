...
A **Poisson random variable (or Poisson distribution)** is a model for the number of events that occur during a fixed time interval. <https://en.wikipedia.org/wiki/Poisson_distribution>
...
The number of <https://en.wikipedia.org/wiki/List_of_Florida_hurricanes_%28200080%93present%29> can be thought of as a Poisson random variable, which means we can model the probabilty of having $x$ tropical storms in a year using 
