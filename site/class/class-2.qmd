...
2. Install an editor to work with R:
    ...
    - **Alternative:** [VS Code](https://code.visualstudio.com/){target="_blank"} — fine if you already use VS Code for other courses, but it requires extra setup. See the note below.

<details>
<summary>Setting up R in VS Code (click to expand)</summary>
