...
- Skim read the [instructions for Project 1](https://chaz-clark.github.io/M119/Projects/unit1.html).
...
2. Install an editor to work with R (pick one):
    - [**RStudio**](https://www.rstudio.com/products/rstudio/download/){target="_blank"} — the long-standing R IDE. Course examples, screenshots, and troubleshooting assume RStudio. Setup: [Install RStudio](https://chaz-clark.github.io/M119/Projects/rstudio_install.html){target="_blank"}.
    - [**Positron**](https://positron.posit.co/){target="_blank"} — Posit's newer IDE (same company as RStudio). Similar layout, single installer, R and Python support built in. Setup: [Install Positron](https://chaz-clark.github.io/M119/Projects/positron_install.html){target="_blank"}.
    - [**VS Code**](https://code.visualstudio.com/){target="_blank"} — fine if you already use VS Code for other courses, but requires extra setup. See the VS Code setup note at the end of this section.
...
4. For rendering Quarto documents, install the [**Quarto CLI**](https://quarto.org/docs/get-started/){target="_blank"} plus the Quarto VS Code extension — then run `quarto render file.qmd` (or use the Quarto preview command from VS Code's command palette).
5. Open an `.R` or `.qmd` file and use **Cmd/Ctrl + Enter** to run the line at your cursor.
