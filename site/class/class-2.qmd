...
- Skim read the instructions for <https://byuistats.github.io/M119/project1.html.>
...
1. Open a new file in RStudio and use it to perform a few computations. One option is to repeat some of the computations you did during class in groups, but this time using R to perform the computations. Or you may pick something else of interest. Feel free to search the web for a tutorial on performing computations with R in RStudio. 

1. Construct the plot of a function (either one from part 2 above, from in class, or one of your choice).
