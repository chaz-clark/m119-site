...
Take a look at this [html file](https://chaz-clark.github.io/M119/Projects/m119-docs/Practice_RMarkdown.html){target="_blank"}. This is an example of a cohesive analysis.
...
- You can download the RMarkdown file used to create this html [here](https://chaz-clark.github.io/M119/Projects/m119-docs/Practice_RMarkdown.Rmd).

### (2) Create your own Cohesive Analysis
- Complete Project 1 Task 1 by creating your own RMarkdown file (feel free to download and modify the one above), and in that file give a short cohesive analysis with the required scatterplot. In other words, take the work you already did and covert it into a short cohesive analysis.
- For some additional practice with RMarkdown and writing cohesive analysis, create your own RMarkdown file (feel free to download and modify the one above), and in that file give a short cohesive analysis that computes the several values of a function taken from one of the exercises we did today. In other words, take the work you've already done in a script file in R, and convert it into a short cohesive analysis.
...
&= af(b(x+c))+d \\
&= a\sqrt{b(x+c)}+d \\
&= 4\sqrt{2(x-3)}+7 &&\text{using }a=4, b=2, c=-3, d=7 \\
&= 4\sqrt{2x-6}+7\\
&= h(x). 
\end{align*}$$
...
1. Let $f(x;a,b) = ax^b$, a generic power function. Consider the transformation $T(x;a,b,A,B,C,D) = Af(B(x-C);a,b)+D$. For each set of values for $a,b,A,B,C,D$ below, do the following. 
    ...
    1. Adapt this [Desmos calculator](https://www.desmos.com/calculator/5jc00j0rpr) to plot and compare the two functions.
...
- We'll open the [Example Project Instructions](../assets/docs/example_project.html){target="_blank"}
