...
Note: We have used the method of substitution to solve the linear system of equations for the parameters $a$ and $b$.
$\left\{
\begin{array}{ll}
a + b(0) &= 10 \\ 
a + b(25) &= 510.
...
$$y = 10 - \sqrt{x+4}$$
where $x$ is the tire pressure and $y$ is the distance to the Sun.
