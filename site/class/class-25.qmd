...
Our goal today is to dig into the derivative relationships and associated vocabulary. Your assignment before class was to fill in as many of the blanks, as possible, from the [Derivative Relationships worksheet (PDF)](../assets/docs/DerivativeRelationship_FillBlank.pdf){target="_blank"}. Compare your answers, discuss any questions, and have a scribe write your solutions on the board (so you can compare with other groups).
