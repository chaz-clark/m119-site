...
2. $$\begin{align*}
\log_4 \left(\prod_{k=1}^{5}(y_k + bx_k)^2\right)
  &= \sum_{k=1}^{5} \log_4\!\left((y_k + bx_k)^2\right) \\
  &= \sum_{k=1}^{5} 2\log_4(y_k + bx_k) \\
  &= 2\sum_{k=1}^{5} \log_4(y_k + bx_k)
\end{align*}$$

3. $$\sum_{k=1}^{4} \ln(100-k^2)$$

4. $$\begin{align*}
\ln\!\left(\prod_{i=1}^{500}(y_i + ax_i)^2\right)
  &= \sum_{i=1}^{500} \ln\!\left((y_i + ax_i)^2\right) \\
  &= \sum_{i=1}^{500} 2\ln(y_i + ax_i) \\
  &= 2\sum_{i=1}^{500} \ln(y_i + ax_i)
\end{align*}$$
